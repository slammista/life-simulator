export type AssetsSubTabId = 'finance' | 'vehicle' | 'living' | 'social'
...
const ITEMS: ItemDef[] = [
  { id: 'finance', emoji: '💰', label: 'Finanze',     subtitle: 'Conti, investimenti e debiti',       color: '#10b981' },
  { id: 'vehicle', emoji: '🚗', label: 'Veicoli',     subtitle: 'Auto, moto e trasporti',              color: '#3b82f6' },
  { id: 'living',  emoji: '🏠', label: 'Abitazione',  subtitle: 'Casa, mutuo e affitto',               color: '#f59e0b' },
  { id: 'social',  emoji: '📱', label: 'Social Media', subtitle: 'Fama online e piattaforme',          color: '#8b5cf6' },
]

export { ITEMS as ASSETS_ITEMS }

interface Props {
  onChange: (sub: AssetsSubTabId) => void
}

export function AssetsNav({ onChange }: Props) {
  return (
