    ...
    <div style={{ padding: '16px 12px' }}>
      ...
      <div className="card" style={{ padding: '16px 14px', marginBottom: 12 }}>
        <p style={{ fontSize: 13, color: 'var(--color-text)' }}>
          Manage your account, sign in, and sync your game progress to the cloud.
        </p>
        <p style={{ fontSize: 12, color: 'var(--color-text-secondary)', marginTop: 8 }}>
          (Coming soon: Google Sign-In, Apple Sign-In, email/password, cloud save sync, leaderboard)
        </p>
      </div>
    </div>
  )
