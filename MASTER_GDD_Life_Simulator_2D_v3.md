...
2. consumare energia
3. applicare salario se il personaggio lavora
4. applicare decadimento naturale
5. applicare effetti nazione
6. controllare eventi casuali
7. filtrare gli eventi validi
8. mostrare l'evento corrente
9. applicare la scelta del giocatore
10. verificare goals, morte e salvataggio
...
2. Installare Zustand, Capacitor e dipendenze base
3. Creare cartelle `src/assets`, `src/components`, `src/store`, `src/data`, `src/services`
4. Inserire i file JSON e lo store

### Fase 2: Motore di gioco
1. Implementare `gameStore.ts`
2. Implementare `handleInvecchia()`
3. Implementare `handleChoice()`
4. Implementare validazione eventi e goals
5. Implementare salvataggio

### Fase 3: UI
1. Creare `HUD`
2. Creare `EventDisplay`
3. Creare `ChoiceButtons`
4. Creare `ActionMenu`
5. Creare schermate secondarie

### Fase 4: Rifinitura
1. Aggiungere bilanciamento
2. Aggiungere nations
3. Aggiungere micro-animazioni Phaser
4. Integrare Capacitor
5. Testare su mobile
...
2. Crea `src/store/gameStore.ts` con stato completo e azioni
3. Crea il motore di validazione eventi e scelte
4. Crea UI modulare React
5. Integra Phaser 3 solo per micro-animazioni
6. Mantieni l'architettura React-centric
7. Assicurati che ogni scelta aggiorni lo stato in modo coerente
8. Implementa bilanciamento, sopravvivenza, goals, morte e salvataggio
9. Non creare file monolitici
10. Scrivi codice pronto per mobile e futuro porting Supabase
...
2. Lezioni teoria (20-30 ore, €40-€60/ora)
3. Esame teoria: 40 domande, max 4 errori (pass rate 65%)
4. Esame pratica: guida con esaminatore (pass rate 55%)
5. Bocciatura → ripetere esame (costo aggiuntivo €100-€200 per tentativo)
6. Patente provvisoria: prima 3 anni, limite 0.5 BAC, max 100 km/h
...
2. Circuiti giovanili/accademia (15-18 anni)
3. Draft o contratto diretto (NBA Draft, contratto pro)
4. Contratto rookie: €500k-€10M/anno
5. Picco carriera: endorsement Nike/Adidas (€1M-€50M/anno)
6. Infortuni (10-20%/anno): carriera finita in caso gravi
7. Retirement (30-40 anni per sport fisici, 40-50 per golf/tennis)
8. Hall of Fame (carriera eccezionale, achievement esclusivo)
9. Post-carriera: coaching, commentatore, business
...
2. Inglese (mercato principale)
3. Spagnolo (80M+ speaker)
4. Portoghese brasiliano (BitLife molto popolare in Brasile)
